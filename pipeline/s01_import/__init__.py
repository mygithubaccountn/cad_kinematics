...
from pipeline.common.models import AssemblyIR
from pipeline.common.tolerances import Tolerances
from pipeline.s01_import.freecad_backend import import_step_freecad, freecad_available
from pipeline.s01_import.synthetic import load_synthetic_assembly, is_synthetic_path
...
def run_import(
    ...
    if is_synthetic_path(source_p):
        ...
        from pipeline.s01_import.freecad_backend import freecad_status
